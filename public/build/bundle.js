    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(code_1, file, 109, 8, 4066);
    			add_location(pre, file, 109, 3, 4061);
    			add_location(script, file, 110, 3, 4141);
    		},
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(i, "aria-hidden", "true");
    			add_location(i, file, 107, 80, 3979);
    			attr_dev(button, "class", "btn svelte-1msgwmh");
    			add_location(button, file, 107, 38, 3937);
    			attr_dev(a3, "href", "#share-py");
    			attr_dev(a3, "role", "button");
    			add_location(a3, file, 107, 4, 3903);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*share_url*/ 8) set_data_dev(t4, /*share_url*/ ctx[3]);
    		},
    		d: function destroy(detaching) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 113, 2, 4207);
    			...
    			add_location(button0, file, 114, 2, 4244);
    			...
    			add_location(button1, file, 117, 2, 4409);
    			...
    			add_location(button2, file, 120, 2, 4557);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 124, 2, 4736);
    			add_location(script1, file, 125, 2, 4762);
    			script2.defer = true;
    			add_location(script2, file, 140, 2, 5184);
    			add_location(center, file, 83, 1, 2563);
    			attr_dev(i, "class", "fa fa-moon-o");
    			attr_dev(i, "aria-hidden", "true");
    			add_location(i, file, 150, 58, 5552);
    			attr_dev(button1, "class", "toggle-theme btn svelte-1msgwmh");
    			add_location(button1, file, 150, 1, 5495);
